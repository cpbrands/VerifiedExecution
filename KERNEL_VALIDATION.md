...
A separate architectural pressure test remains open: whether execution
authority can be selected entirely through Claims and Trust Context
scope without reintroducing `Resource` as a kernel primitive.
# KERNEL_VALIDATION.md
