...
## Accepted decisions — narrow VE Kernel Protocol v0.1 scope

These decisions are authoritative only at the scope accepted in [ADR-ENC-001](adrs/ADR-ENC-001-VE-CBOR-1.md) and [ADR-RULE-001/002](adrs/ADR-RULE-001-002-VE-CEL-1.md). This patch is a historical integration aid, not an independent normative specification.
